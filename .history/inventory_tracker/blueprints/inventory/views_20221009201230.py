...
#        None
    ...
    return render_template("inventory_stats.xhtml", total_spend=total_spend.total_spend, total_refund=total_returns.refund_total, after_refunds=after_returns)#string_after_returns)#, form=form)