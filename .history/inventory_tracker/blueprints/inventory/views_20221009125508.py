...
#        None
    ...
    return render_template("inventory_stats.xhtml", total_spend=total_spend.total_spend, total_refund=total_returns.refund_total, total_spend_after_returns=after_returns)#, form=form)