...
#        None
    ...
    return render_template("inventory_stats.xhtml", total_spend=total_spend.total_spend, total_refund=total_returns.refund_total, spend_after_returs=after_returns)#, form=form)